<?php 
	...
	$pass ='bestpriceproject';
	  
	$dbh = mysql_connect($host, $user, $pass)or die(mysql_error());
	$selected = mysql_select_db("id1717130_products",$dbh);
	if(isset($_GET['button'])){
	$search = $_GET['search'];
	echo $search;
	$result= mysql_query("select * from categories where MainCategory = 0 && (Description like '%{$search}%'
	|| name like '%{$search}%')");
...
<!DOCTYPE html>
<html>
<img class="style1"  style="width: 2000px;" src="wallpaper1.jpg" id="menu-back" /> 
<head>
